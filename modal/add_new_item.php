            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form" id="form-item">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="number" maxlength="100" class="form-control" id="grams" placeholder="Ingresa la cantidad" required="" autofocus="">
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                            <select id="item-type" class="btn btn-default">
                                <?php foreach ($types as $t) : ?>
                                    <option value="<?= $t['codigo']; ?>"><?= ucwords($t['nombre']); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
